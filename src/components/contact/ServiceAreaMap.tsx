    ...
    <section className="py-20 bg-brand-gray">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-brand-navy mb-8 text-center">{t('locations.mapTitle')}</h2>
          ...
          <p className="mt-4 text-center text-gray-600">
            ...
            <br />
            <a href="/locations" className="text-brand-red hover:underline">View our detailed service area map</a>
          </p>
        </div>
      </div>
    </section>
