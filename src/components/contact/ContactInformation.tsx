    ...
    <div>
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-700">
              <a href="mailto:info@unclesamjunkremoval.com" className="hover:text-brand-red transition-colors text-lg">
                info@unclesamjunkremoval.com
              </a>
            </p>
          </div>
        </div>
      ...
      <div className="mt-10">
        ...
        <div className="flex space-x-4">
          <a 
            href="https://facebook.com/unclesamjunkremoval" 
            target="_blank" 
          ...
          <a 
            href="https://instagram.com/unclesamjunkremoval" 
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-gray-100 hover:bg-gray-200 p-3.5 rounded-full transition-colors shadow-sm"
          ...
          <a 
            href="https://twitter.com/unclesamjunk" 
            target="_blank" 
            rel="noopener noreferrer"
            className="bg-gray-100 hover:bg-gray-200 p-3.5 rounded-full transition-colors shadow-sm"
            aria-label="Twitter"
