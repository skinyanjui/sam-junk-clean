...
const TruckVisualizer = ({ pricingTiers: propTiers }: TruckVisualizerProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Add XL truck load tier as a separate section */}
      {xlTier && (
        <div className="bg-brand-navy/10 p-4 border-l-4 border-brand-navy rounded-r-lg shadow-sm">
          <div className="flex flex-wrap justify-between items-center">
            <div>
              <h4 className="font-bold text-brand-navy">{xlTier.tier_name}</h4>
              <p className="text-sm text-gray-700">{xlTier.description}</p>
            </div>
