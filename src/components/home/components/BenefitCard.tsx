...
const BenefitCard = ({ benefit, index }: BenefitCardProps) => {
  ...
  return (
    <motion.div variants={itemVariants}>
      <Card className="bg-white/80 backdrop-blur-sm border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 h-full overflow-hidden group">
