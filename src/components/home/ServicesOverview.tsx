...
const ServicesOverview = () => {
  ...
  return (
    <section className={`py-12 ${isMobile ? 'px-4' : 'py-20'} bg-white relative`}>
      ...
      <div className="container-custom text-center mb-8 md:mb-16 relative z-10">
        <span className="text-brand-red font-semibold uppercase tracking-wider mb-2 block">What We Do</span>
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-brand-navy mb-4 md:mb-6">Our Services</h2>
